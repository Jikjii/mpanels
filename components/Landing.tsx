        ...
        <div className='relative flex justify-center'>
                  ...
                  <div className='relative h-[9.2rem] w-28 bg-cover'>
                    <motion.div variants={variants}>
                      <motion.div variants={item}>
                        <Image
                          alt='Iyoba'
                          src='https://i.pinimg.com/564x/56/51/5f/56515f8baa7eefd79ab60ec4894a9669.jpg'
                          height={180}
                          width={130}
                        />
                      </motion.div>
                  ...
                  <div className='relative h-44 w-36 bg-cover'>
                    <motion.div variants={variants}>
                      <motion.div variants={item} className='mr-2'>
                        <Image
                          alt='Brinley'
                          src='https://i.pinimg.com/564x/09/43/de/0943dec686ae29c7d9f4d8913491d097.jpg'
                          height={195}
                          width={145}
                        />
                      </motion.div>
                  ...
                  <div className='relative h-44 w-32 bg-cover'>
                    <motion.div variants={variants}>
                      <motion.div variants={item}>
                        <Image
                          alt='Pieta'
                          src='https://i.pinimg.com/564x/db/ca/77/dbca7753315a6c9b709dc5d98f548c55.jpg'
                          height={190}
                          width={130}
                        />
                      </motion.div>
                  ...
                  <div className='relative h-28 w-32 bg-cover'>
                    <motion.div variants={variants}>
                      <motion.div variants={item}>
                        <Image
                          alt='Dionysos'
                          src='https://i.pinimg.com/564x/24/e8/a6/24e8a6ff7d1e21d70f73cfd81caaad11.jpg'
                          height={170}
                          width={130}
                        />
                      </motion.div>
          ...
          <div className='z-10 w-full text-left lg:text-center'>
            <motion.div initial='initial' animate='animate'>
              ...
              >
                Welcome <span className='ogg-regular-italic'>to</span> MPanels
              </motion.h2>
            </motion.div>
            <div className='plain-medium ml-0 mt-6 flex justify-start text-left lg:mt-14 lg:ml-72 lg:justify-center'>
              ...
              >
                ...
                >
                  A platform dedicated towards Anime and Manga lovers to find
                  new Reads, also to enjoy some got old beutiful panels. Prepare
                  to find your new past time.
                </motion.span>
                <motion.div
                  variants={isDesktop ? fadeInUp2 : fadeInUp2Mobile}
